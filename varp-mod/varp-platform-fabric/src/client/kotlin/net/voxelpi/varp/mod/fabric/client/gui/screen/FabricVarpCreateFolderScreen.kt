...
class FabricVarpCreateFolderScreen(
    ...
    override fun build(rootComponent: FlowLayout) {
        ...
        val idInput = UIComponents.textBox(Sizing.fill(60), "folder").apply {
            setMaxLength(256)
            margins(Insets.vertical(2))
        }

        val nameInput = UIComponents.textBox(Sizing.fill(60), "Folder").apply {
            setMaxLength(1024)
            margins(Insets.vertical(2))
        }
        ...
        menuPlane.child(
            UIContainers.horizontalFlow(Sizing.fill(95), Sizing.fixed(20)).apply {
                child(
                    UIComponents.texture(Identifier.parse("varp:textures/gui/create_folder.png"), 0, 0, 16, 16, 16, 16).apply {
                        margins(Insets.of(0, 0, 0, 8))
                    }
                )
                child(
                    UIComponents.label(net.minecraft.network.chat.Component.translatable("gui.varp.create_folder.message")).apply {
            ...
            UIContainers.verticalFlow(Sizing.fill(100), Sizing.content()).apply {
                child(
                    UIContainers.horizontalFlow(Sizing.content(), Sizing.content()).apply {
                        child(
                            UIComponents.label(net.minecraft.network.chat.Component.translatable("gui.varp.create_folder.id")).apply {
                ...
                child(
                    UIContainers.horizontalFlow(Sizing.content(), Sizing.content()).apply {
                        child(
                            UIComponents.label(net.minecraft.network.chat.Component.translatable("gui.varp.create_folder.name")).apply {
                                horizontalTextAlignment(HorizontalAlignment.RIGHT)
                                verticalTextAlignment(VerticalAlignment.CENTER)
                                sizing(Sizing.fill(25), Sizing.fixed(24))
                                margins(Insets.right(8))
                ...
                child(
                    UIContainers.horizontalFlow(Sizing.content(), Sizing.content()).apply {
                        child(
                            UIComponents.label(net.minecraft.network.chat.Component.translatable("gui.varp.create_folder.parent")).apply {
                                horizontalTextAlignment(HorizontalAlignment.RIGHT)
                                verticalTextAlignment(VerticalAlignment.CENTER)
                                sizing(Sizing.fill(25), Sizing.fixed(24))
                                margins(Insets.right(8))
                        ...
                        child(
                            UIComponents.button(net.minecraft.network.chat.Component.translatable("gui.varp.create_folder.select_parent")) {}.apply {
        ...
        menuPlane.child(
            UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content()).apply {
                child(
                    UIComponents.button(net.minecraft.network.chat.Component.translatable("gui.varp.create_folder.cancel")) {
