...
public fun <C : Any> nodeChildParser(treeProvider: (context: CommandContext<C>) -> Tree): ParserDescriptor<C, NodeChild> {
    return ParserDescriptor.of(
        NodeChildParser(treeProvider),
        NodeChild::class.java,
    )
}

public fun <C : Any> nodeChildParser(): ParserDescriptor<C, NodeChild> {
    return ParserDescriptor.of(
        NodeChildParser { it[VarpCommandArguments.TREE] },
        NodeChild::class.java,
    )
}
